...
export const metadata: Metadata = {
  title: "Help Center — KaabaPass",
  description: "Find answers to common Umrah travel questions, visa requirements, and booking support.",
};
    ...
    <div className="bg-neutral min-h-screen">
      ...
      <div className="max-w-[720px] mx-auto px-4 md:px-6 py-12">
        <div className="mb-8">
          ...
          <FAQAccordion faqs={FAQS} showAll />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              label: "Email",
              value: "support@kaabapass.com",
              sub: "Response within 4 hours",
              href: "mailto:support@kaabapass.com",
            },
          ].map((c) => (
            <a
              key={c.label}
